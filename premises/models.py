...
class Premises(models.Model):
    ...
    price = models.DecimalField(max_digits=9, decimal_places=0, verbose_name='Цена за час')
    sale = models.DecimalField(max_digits=9, decimal_places=0, verbose_name='Цена по скидке')
